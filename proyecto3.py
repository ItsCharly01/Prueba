...
toolbox.register("mate", tools.cxPartialyMatched)                                   #operador cruza
toolbox.register("mutate", tools.mutShuffleIndexes, indpb=2.0/NB_QUEENS)            #operador mutacion
toolbox.register("select", tools.selTournament, tournsize=3)                        #operador de seleccion
...
if __name__ == "__main__":
    ...
    x= range(NB_QUEENS)
    x= numpy.array(x)
    print("individuo en x",x)
    y = numpy.array(y)
   
    print("individuo en y",y)  
